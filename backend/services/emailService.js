...
// Support email - ใช้เป็น reply-to และแสดงในเมลยืนยันการชำระเงินถึงลูกค้า
const SUPPORT_EMAIL = process.env.SUPPORT_EMAIL || process.env.ADMIN_EMAIL || 'support@dsmuaythaiticket.com';
...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      <p class="footer-text">Contact: <a href="mailto:${SUPPORT_EMAIL}" style="color: #16a34a; text-decoration: none; font-weight: 600;">${SUPPORT_EMAIL}</a></p>
    </div>
  </div>
</body>
</html>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Verify Email - DS Muay Thai</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
  ...
  <div class="container">
    ...
    <div class="content">
      <div class="message-section">
        ...
        <p>Please click the button below to verify your email and proceed to the payment selection page.</p>
      ...
      <div class="warning">
        ...
        <span class="warning-text">This link will expire in ${expiresInMinutes} minutes. Please verify your email as soon as possible.</span>
      </div>
    </div>
  ...
  async sendVerificationEmail(email, token, bookingData) {
    try {
      ...
      const mailOptions = {
        from: `"DS Muay Thai Tickets" <${EMAIL_CONFIG.auth.user}>`,
        to: email,
        subject: `🔐 Verify Email - DS Muay Thai Tickets`,
        html: html
      };
