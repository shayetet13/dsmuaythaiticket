...
const App = () => {
  ...
  const { heroImage, highlights, stadiums, weeklyFights, stadiumImageSchedules, specialMatches, dailyImages, dbLoaded } = useDatabase(language);
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (currentPath.includes('/booking') || currentPath.includes('/schedule/')) {
        title = language === 'th' 
          ? 'จองตั๋วมวยไทยออนไลน์ - DS MUAY THAI TICKET'
          : 'Book Muay Thai Tickets Online - DS MUAY THAI TICKET';
        ...
        title = language === 'th'
          ? 'ชำระเงินตั๋วมวยไทย - DS MUAY THAI TICKET'
          : 'Pay for Muay Thai Tickets - DS MUAY THAI TICKET';
        description = language === 'th'
        ...
        title = language === 'th'
          ? 'ชำระเงินสำเร็จ - DS MUAY THAI TICKET'
          : 'Payment Successful - DS MUAY THAI TICKET';
        description = language === 'th'
