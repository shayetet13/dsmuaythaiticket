...
const BookingPage = ({ stadiumIdFromPath: stadiumIdFromProps }) => {
  ...
  React.useEffect(() => {
    if (stadiumData?.name) {
      ...
      document.title = `${baseName} Fight Schedule - DS MUAY THAI TICKET`;
    } else {
      document.title = 'DS MUAY THAI TICKET';
    }
  ...
  }, [selectedStadium, selectedDate, selectedZone, bookingStep, navigate]);
