...
import { ChevronLeft, Clock, QrCode, RefreshCw, CheckCircle, AlertCircle, X, Home, Download } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!showQRCode && !isLoading && (
          <>
            ...
            <div className="flex gap-4">
              <button
                onClick={handleBackClick}
                className="flex-1 bg-gray-700 text-white font-black text-lg px-8 py-4 rounded-lg uppercase tracking-wider hover:bg-gray-600 transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 bg-yellow-500 text-black font-black text-lg px-8 py-4 rounded-lg uppercase tracking-wider hover:bg-yellow-400 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
              >
                {isCheckingTicket ? (
                  <>
        ...
        {!isLoading && !error && paymentStatus === 'pending' && showQRCode && (
          <>
            {/* Booking Summary */}
            <div className="mb-6 bg-gray-900 rounded-lg p-4 sm:p-6 border border-yellow-500">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">
              ...
              {qrCodeImage ? (
                <div className="flex flex-col items-center">
                  ...
                  <button
                    ...
                    className="mt-4 flex items-center gap-2 bg-blue-500 text-white font-bold px-6 py-3 rounded-lg hover:bg-blue-400 transition-colors shadow-lg"
                  >
