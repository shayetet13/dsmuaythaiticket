  ...
  return (
    ...
    >
      ...
      <div className="text-center p-4 sm:p-5 md:p-6 pb-3 sm:pb-4 bg-black">
        ...
        <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black text-yellow-500 uppercase tracking-tight mb-2">
      ...
      <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[400px]">
        {stadium.image ? (
          <img
            src={stadium.image}
            alt={`${stadiumName} Muay Thai Stadium - Book official tickets online for ${stadiumName} fights`}
        ...
        {bookingStep === 'stadium' && (
            <div className="space-y-8 md:space-y-12">
              ...
              {bangkokStadiums.length > 0 && (
                <div>
                  <h2 className={`text-xl sm:text-2xl md:text-3xl font-black ${lightBackground ? 'text-red-600' : 'text-yellow-500'} uppercase mb-6 text-center`}>
                    ...
                    {zones.map(zone => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          // ✅ เด้งไปหน้า payment เพื่อกรอก Quantity และ Customer Information (legacy zones)
                          const params = new URLSearchParams();
                          params.set('stadium', selectedStadium);
                          params.set('date', selectedDate);
                          ...
                          <div
                            ...
                            onClick={() => {
                              if (!isOutOfStock) {
                                ...
                                // ✅ เด้งไปหน้า payment เพื่อกรอก Quantity และ Customer Information
                                const params = new URLSearchParams();
                                params.set('stadium', selectedStadium);
                                params.set('date', selectedDate);
                                params.set('ticket', ticketZone);
                                params.set('step', 'payment');
                                navigate(`/booking?${params.toString()}`, { replace: true });
                                window.scrollTo({ top: 0, behavior: 'instant' });
                              }
