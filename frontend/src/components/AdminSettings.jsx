        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">เปลี่ยนรหัสผ่านสำหรับเข้าสู่ระบบ Admin</p>
            </div>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">อัพโหลดและแก้ไข QR Code สำหรับการชำระเงินผ่าน PromptPay</p>
            </div>
          </div>
