...
import { TH_PROVINCES, getProvinceLocation, getProvinceIdFromLocation } from '../constants/provinces';
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const stadiumData = {
                        id,
                        name: editForm.name,
                        location: editForm.location || getProvinceLocation(editForm.province),
              ...
              {editingId === stadium.id ? (
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">จังหวัด</label>
                    <select
                      value={editForm.province || getProvinceIdFromLocation(editForm.location) || 'bangkok'}
                      onChange={(e) => {
                        const province = e.target.value;
                        setEditForm({
                          ...editForm,
                ...
                <>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const province = getProvinceIdFromLocation(stadium.location) || 'bangkok';
                      setEditForm({ 
                        ...stadium,
                        province,
