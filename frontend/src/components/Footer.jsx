  ...
  return (
    <footer id="footer" className="bg-black border-t-2 border-red-600 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-12 max-w-5xl mx-auto">
          {/* Contact */}
          <div>
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-yellow-500 mb-4 sm:mb-6 uppercase tracking-wider">
              {t.contact.title}
            </h3>
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-400">
              <li className="flex items-center gap-2">
                <MapPin className="w-12 h-12 text-yellow-500" />
                {language === 'th' ? '99/204 หมู่ 13 หมู่บ้านกัสโต้ทาวโฮมวงแหวนพระราม5 ตำบล บางมวง อำเภอ บางใหญ่ จังหวัด นนทบุรี 11140' : '99/204 Moo 13 Gusto Townhome Wongwaen Rama 5 Bang Muang Subdistrict Bang Yai District Nonthaburi 11140 Thailand'}
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                {import.meta.env.VITE_SUPPORT_EMAIL || 'support@dsmuaythaiticket.com'}
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-4 mt-4 sm:mt-6">
              <a 
                href="https://www.facebook.com/share/1Df1sRNu2h/?mibextid=wwXIfr" 
                target="_blank" 
              ...
              <a 
                href="https://wa.me/message/RRGHZPOK2PITF1" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-yellow-500 hover:text-yellow-400 transition-colors"
                aria-label="WhatsApp"
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 text-center">
          ...
          <p className="text-gray-500 text-xs sm:text-sm px-2">
            DS Muay Thai Tickets Powered By{' '}
            <a 
