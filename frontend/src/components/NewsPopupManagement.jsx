    ...
    <div>
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-black text-white uppercase">News Pop up</h3>
          <button
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-3 py-2 rounded text-sm"
                    >
                      แก้ไข
                    </button>
                    <button
