...
import { Image as ImageIcon, Trash2, Plus, Save, X, Calendar } from 'lucide-react';
import { 
...
const UpcomingFightsManagement = () => {
  ...
  const [selectedStadium, setSelectedStadium] = useState('rajadamnern');
  ...
  return (
    <div>
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700 mb-6">
        <div className="flex space-x-1 p-2">
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-semibold uppercase tracking-wider transition-colors ${
              activeTab === 'images'
      ...
      {activeTab === 'images' && (
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-black text-white uppercase">แก้ไขภาพสนาม</h3>
            <button
              onClick={handleAddSchedule}
              className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-4 py-2 rounded flex items-center gap-2"
            >
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {Object.keys(stadiumNames).map((stadiumId) => (
                <button
                  key={stadiumId}
                  onClick={() => setSelectedStadium(stadiumId)}
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-bold text-white mb-4">
              รายการภาพสำหรับสนาม{stadiumNames[selectedStadium]}
            </h4>
      ...
      {activeTab === 'special' && (
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-black text-white uppercase">แมตช์พิเศษ</h3>
            <button
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-300 mb-2">เลือกสนาม</label>
                  <select
                    value={editForm.stadiumId || 'rajadamnern'}
                  ...
                  >
                    {Object.keys(stadiumNames).map((stadiumId) => (
                      <option key={stadiumId} value={stadiumId}>
                        {stadiumNames[stadiumId]}
                      </option>
                    ))}
                  </select>
                ...
                {specialMatches.map((match) => (
                  ...
                  >
                    ...
                    <div className="mb-3">
                      ...
                      <p className="text-white font-semibold">{stadiumNames[match.stadiumId] || match.stadiumId}</p>
                    </div>
                    <div className="mb-3">
