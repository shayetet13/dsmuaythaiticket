...
// Lazy load TicketsManagement (contains react-quill ~200KB) - only when user clicks Tickets tab
const TicketsManagement = lazy(() => import('./TicketsManagement'));
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-8">
        ...
        {activeTab === 'tickets' && (
          <Suspense fallback={<div className="flex justify-center py-12"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-yellow-500" /></div>}>
            <TicketsManagement />
          </Suspense>
        )}
