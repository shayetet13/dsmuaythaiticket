...
import { Ticket, Calendar, MapPin, Plus, X, Save, Trash2, Edit2, ArrowLeft, ChevronLeft, Upload, Image as ImageIcon, Settings } from 'lucide-react';
            ...
            <div className="space-y-3">
              {(() => {
                ...
                return specialTicketsWithMatches.length === 0 ? (
                  ...
                  specialTicketsWithMatches.map((ticket) => (
                  <div
                    key={ticket.id}
