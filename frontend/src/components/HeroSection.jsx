...
const HeroSection = ({ heroImage, t }) => {
  ...
  return (
    <section id="home" className="relative h-[55vh] min-h-[380px] max-h-[550px] md:max-h-[600px] lg:max-h-[660px] xl:max-h-[720px] flex items-start justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 sm:pt-36 lg:pt-40 pb-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-black text-white mb-3 sm:mb-4 leading-tight tracking-tight uppercase">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-3xl mx-auto pl-8 sm:pl-12 md:pl-16 lg:pl-20 pr-2 whitespace-pre-line text-left">
          {t.hero.description}
        </p>
      </div>
    </section>
