    ...
    <section id="home" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          onError={(e) => {
            // Fallback to fallback image if hero image doesn't exist
            if (e.target.src !== heroImage.fallback) {
              e.target.src = heroImage.fallback || '/images/highlights/World class fighters.jpg';
            }
          }}
        />
