      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-300">
              🌐 Website: <a href="https://dsmuaythaiticket.com" className="text-yellow-500 hover:text-yellow-400 hover:underline transition-colors" target="_blank" rel="noopener noreferrer">
